...
const solutions = {
    ...
    HeroSection: {
        contentLeft: {
            ...
            descriptions: [
                "Health and wellbeing of employees determines the wellbeing of a company. A healthy employee is more productive and brings growth and profit. When you take responsibility for the health of your employees then that increases the reputation of your company and increases employee retention.",
                "Give digital experience to new- age health conscious employees!!"
            ],
            buttons: {
                services: {
                    text: "Our Services",
    ...
    Features: {
        ...
        contentLeft: {
            content: {
                ...
                description: [
                    {
                        text: "We have innovative smart  corporate health solutions to offer our corporate clients.We are the first one to bring the concept of a corporate dashboard for the health status analysis of employees."
                    },
                ]
            }
        },
    ...
    Advantages: {
        ...
        contentLeft: {
            content: {
                ...
                description: [
                    { text: "These digital corporate dashboards are a must have for any good company as it helps employers in taking better decisions regarding health policies, medical leaves, providing health cover and health insurance etc.  " },
                    { text: "It can help in taking preventive measures to improve the overall health of your employees.For example, if cholesterol levels are found higher than normal in a significantly higher portion of your workforce then you may consider changing the menu of your canteen." },
                    { text: "When employees are provided regular health checkups then that increases morale of employees  and increases their engagement with the company." },
                ]
            }
        },
        contentRight: {
