const privacyPolicy = {
    self: { url: "/privacy-policy", text: "Privacy Policy", onNavbar: false },
    PrivacyPolicy: {
        header: {
            heading: [{ text: "Privacy Policy." },],
            description: [
                { text: "Last updated: February 2021 ", style: { color: "grey" } },
                { text: 'NirogGyan ("us", "we", or "our") operates https://www.niroggyan.com (the "Site"). This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.' },
    ...
    LogData: {
        header: {
            ...
            description: [
                ...
                { text: `In addition, we may use third party services such as Google Analytics that collect, monitor and analyze this information.` },
            ]
        }
    },
    Communications: {
        header: {
            ...
            description: [
                { text: 'We may use your Personal Information to contact you with newsletters, marketing or promotional materials and other information that you can anytime tell us not to send you.' },
            ]
        }
    },
    Cookies: {
        header: {
            heading: [{ text: "Communications" },],
            description: [
                { text: `Cookies are files with a small amount of data, which may include an anonymous unique identifier. Cookies are sent to your browser from a web site and stored on your computer's hard drive.` },
    ...
    ChangesToThisPrivacyPolicy: {
        header: {
            ...
            description: [
                { text: `This Privacy Policy is effective as of February 2021 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.` },
    ...
    ContactUs: {
        header: {
            ...
            description: [{ text: "If you have any questions about this Privacy Policy, please contact us at contact@niroggyan.com." }]
        }
    }
};
